...
public class Main {
    ...
    public static void setIsExistInRow(int x, boolean[] isExist) {
        for(int j=0; j<N; j++) {
            int num = arr[x][j];
    ...
    public static void setIsExistInColumn(int y, boolean[] isExist) {
        for(int i=0; i<N; i++) {
            int num = arr[i][y];
    ...
    public static void setIsExistInBlock(int x, int y, boolean[] isExist) {
        int sx = (x / 3) * 3;
        int sy = (y / 3) * 3;
